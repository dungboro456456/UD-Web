...
<button type='submit' style='border:none'><i class="fas fa-sign-out-alt"></i></button>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="/admin/categories" class="brand-link">
      <img src="/admin/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">Ứng dụng LTW</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="http://nguyentandung.test/admin/categories#" class="d-block">Nguyễn Tấn Dũng-2121110243</a>
        </div>
      </div>
