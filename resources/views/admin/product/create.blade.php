                  ...
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                        ...
                        <input class="form-control" id="cat_name" name="cat_name" require placeholder="VD:Thời trang nam ">
                      </div>
                        ...
                        <div class="form-group">
                          ...
                          <textarea class="form-control" id="slug" name="slug" require placeholder="VD:Thời-trang-nam-đẹp-số-dách, đẹp-hơn-Sơn Tùng, chấp-tùng-núi, chấp-sếp-3-bước "></textarea>
                        </div>
                      ...
                      <div class="col-md-6">
                         ...
                         <select name="type" id="type">
                          ...
                          <div class="form-group">
                            ...
                            <input  class="form-control" id="author" name="author" require placeholder="VD:Dung ">
                          </div>
