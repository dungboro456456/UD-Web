            ...
            <tbody> 
                ...
                <tr> 
                    ...
                    <td>
                      ...
                      <a class="btn btn-sm btn-info p-3 mr-2" style="border-radius: 17%"; href="/admin/categories/restore/{{$category->id}}"> 
                        <i class="fas fa-backward"></i>
                        </a>
                        <a class="btn btn-sm btn-danger p-3 mr-2" style="border-radius: 17%"; href="/admin/categories/remove/{{$category->id}}"> 
